...
- Mark AAs as **owned** (what you've actually trained in-game, as opposed to just planned) right from the Progression tab — shown with a strikethrough, undoable like any other change. Reset Build keeps owned AAs by default (a checkbox opts into clearing them too), and owned progress is left out of exported text/share links unless you opt in, since it's personal rather than part of the plan you're sharing
