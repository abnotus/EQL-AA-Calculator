...
{ name: "Burst of Power", ranks: 3, costs: ["3","6","9"], levelReq: "46", description: "Increases flurry chance by 7/11/?%." },
...
{ name: "Healing Boon", ranks: 3, costs: ["3","6","9"], levelReq: "1", description: "Increases HoT exceptional heal chance by 3/6/10%." },
...
{ name: "Rampage", ranks: 1, costs: ["5"], levelReq: "30", description: "Activated: performs a single primary combat round on all creatures within 40 feet. Cooldown is reduced by 1 minute each time Frenzy or Cleave is used (40 seconds if in Berserker Stance). (Refresh 0:10:00)" },
