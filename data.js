...
{ name: "Spell Casting Subtlety", ranks: 6, costs: ["2","0","4","0","6","0"], levelReq: "1", eligibleClasses: ["Enchanter","Magician","Necromancer","Wizard"], description: "Reduces hate generated by attacks/spells by 5/10/20%. Disabled by default — purchase the 0-cost rank to enable it. (Refresh 0:00:01)" },
{ name: "Thief's Intuition", ranks: 4, costs: ["3","6","?","?"], levelReq: "1", eligibleClasses: ["Bard","Rogue"], description: "Reduces Sense Traps and Disarm Traps reuse time by 1/3/?/? second(s) per rank." }
],
special: [
...
{ name: "Conjurer's Efficiency", ranks: 5, costs: ["3","5","6","6","6"], levelReq: "1", description: "Rank 1 stops pet summoning components from being consumed. Ranks 2, 3 and 4 cut the cast time of your summon item, pet and target spells by 10%, 25% and 50%, and of your summon swarm pet spells by 2%, 5% and 10%. Rank 5 makes Reclaim Energy return 95% of your current pet's base mana cost." },
