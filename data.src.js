...
const AA_DATA = {
  ...
  archetype: [
    ...
    { name: "Innate Camouflage", ranks: 1, costs: ["5"], levelReq: "40", eligibleClasses: ["Druid","Ranger"], description: "Grants standard invisibility for up to 20 minutes." },
    ...
    { name: "Master of All", ranks: 4, costs: ["5","5","5","5"], levelReq: "20", eligibleClasses: ["Cleric","Druid","Enchanter","Magician","Necromancer","Shaman","Wizard"], description: "Allows a second specialization." },
  ...
  classes: {
    ...
    "Magician": [
      ...
      { name: "Turn Summoned", ranks: 3, costs: ["3","?","?"], levelReq: "45", description: "Activated: deals 400 damage to your elemental target, with a 5% chance to trigger a critical 32000 damage effect. (Refresh 0:05:00) Rank 2 requires level 59, above the current level cap - not reachable for now." },
