...
const AA_DATA = {
  general: [
    ...
    { name: "Full Potential", ranks: 1, costs: ["0"], levelReq: "50", description: "Increases storage capacity: +50 Tradeskill slots, +25 Dragon's Hoard, +5 Activated Item Slots, +25 Equipment Slots, +25 Exaltation Slots." },
    ...
    { name: "Innate Metabolism", ranks: 3, costs: ["1","1","2"], levelReq: "1", description: "Reduces your food and drink consumption by 110/125/150%." },
  ...
  archetype: [
    ...
    { name: "Destructive Fury", ranks: 3, costs: ["2","4","6"], levelReq: "1", eligibleClasses: ["Bard","Beastlord","Cleric","Druid","Enchanter","Magician","Necromancer","Paladin","Ranger","Shadow Knight","Shaman","Wizard"], prereq: "Requires Fury of Magic rank 1", description: "Increases critical direct damage spell damage by 30/60/100%." },
    { name: "Double Riposte", ranks: 3, costs: ["3","6","9"], levelReq: "15", eligibleClasses: ["Bard","Beastlord","Berserker","Monk","Paladin","Ranger","Rogue","Shadow Knight","Warrior"], description: "Grants 5%/10%/15% double riposte chance." },
    { name: "Exodus", ranks: 1, costs: ["6"], levelReq: "10", eligibleClasses: ["Druid","Wizard"], description: "Teleports group members within 100 feet to a safe zone location." },
    { name: "Finishing Blow", ranks: 3, costs: ["2","4","6"], levelReq: "1", eligibleClasses: ["Bard","Beastlord","Berserker","Monk","Paladin","Ranger","Rogue","Shadow Knight","Warrior"], description: "Critical melee attacks deal 100/200/300% damage to level 50/53/55 or lower NPCs at 10/12/15% or less health." },
    { name: "Fury of Magic", ranks: 4, costs: ["1","2","3","4"], levelReq: "1", eligibleClasses: ["Beastlord","Cleric","Druid","Enchanter","Magician","Necromancer","Paladin","Ranger","Shadow Knight","Shaman","Wizard"], description: "Increases critical hit chance with direct damage spells by 2/4/7/10%." },
    { name: "Healing Adept", ranks: 3, costs: ["2","4","6"], levelReq: "1", eligibleClasses: ["Beastlord","Cleric","Druid","Paladin","Ranger","Shaman"], description: "Increases instant-duration healing spell effectiveness by 2/5/10%." },
    { name: "Healing Boon", ranks: 3, costs: ["3","6","9"], levelReq: "1", eligibleClasses: ["Cleric","Druid","Paladin","Shaman"], description: "Increases HoT exceptional heal chance by 3/6/10%." },
    { name: "Healing Gift", ranks: 3, costs: ["2","4","6"], levelReq: "1", eligibleClasses: ["Beastlord","Cleric","Druid","Paladin","Ranger","Shaman"], description: "Grants instant healing spells 3%/6%/10% exceptional heal chance." },
    { name: "Improved Bash", ranks: 1, costs: ["6"], levelReq: "1", eligibleClasses: ["Paladin","Shadow Knight","Warrior"], description: "Allows bash usage without a shield equipped, using the best available AC among your weapon and shield across your Primary, Secondary, and Any slots." },
    { name: "Innate Camouflage", ranks: 1, costs: ["5"], levelReq: "40", eligibleClasses: ["Druid","Ranger"], description: "Grants standard invisibility for up to 20 minutes, though it can wear off early - instant cast, 7-second cooldown." },
    { name: "Innate Invis to Undead", ranks: 1, costs: ["3"], levelReq: "40", eligibleClasses: ["Cleric","Necromancer"], description: "Renders you invisible to undead for up to 27 minutes." },
    { name: "Intimidation", ranks: 1, costs: ["0"], levelReq: "1", auto: true, eligibleClasses: ["Bard","Berserker","Monk","Rogue"], description: "Successful intimidate triggers a fear effect on level 70 or lower targets for 18 seconds." },
    { name: "Mass Group Buff", ranks: 1, costs: ["9"], levelReq: "50", eligibleClasses: ["Beastlord","Cleric","Druid","Enchanter","Magician","Necromancer","Paladin","Ranger","Shaman"], description: "Doubles the mana cost of your next spell, causing it to land on all allies within radius." },
    { name: "Master of All", ranks: 1, costs: ["10"], levelReq: "20", eligibleClasses: ["Cleric","Druid","Enchanter","Magician","Necromancer","Shaman","Wizard"], description: "Increases all of your specialization skills beyond their normal limit." },
    { name: "Mastery of the Past", ranks: 3, costs: ["2","4","6"], levelReq: "1", eligibleClasses: ["Bard","Beastlord","Cleric","Druid","Enchanter","Magician","Necromancer","Paladin","Ranger","Shadow Knight","Shaman","Wizard"], description: "Makes fizzling impossible for level 20/40/52 or lower spells." },
    { name: "Mend Companion", ranks: 1, costs: ["5"], levelReq: "39", eligibleClasses: ["Beastlord","Magician","Necromancer"], description: "Instantly heals your pet for 5000 health." },
    { name: "Mental Clarity", ranks: 4, costs: ["2","3","4","5"], levelReq: "1", eligibleClasses: ["Bard","Beastlord","Cleric","Druid","Enchanter","Magician","Necromancer","Paladin","Ranger","Shadow Knight","Shaman","Wizard"], description: "Increases mana regeneration by 1 point per rank." },
    { name: "Mnemonic Retention", ranks: 6, costs: ["1","1","2","2","3","3"], levelReq: "1", eligibleClasses: ["Bard","Beastlord","Cleric","Druid","Enchanter","Magician","Necromancer","Paladin","Ranger","Shadow Knight","Shaman","Wizard"], description: "Allows memorizing 1/2/3/4/5/6 additional spells." },
    { name: "Persistent Casting", ranks: 6, costs: ["1","2","3","4","5","6"], levelReq: "1", eligibleClasses: ["Bard","Beastlord","Cleric","Druid","Enchanter","Magician","Necromancer","Paladin","Ranger","Shadow Knight","Shaman","Wizard"], description: "Grants an 11% chance (per rank) to complete a spell cast when stunned." },
    { name: "Pet Affinity", ranks: 1, costs: ["2"], levelReq: "1", eligibleClasses: ["Beastlord","Druid","Enchanter","Magician","Necromancer","Shadow Knight","Shaman","Wizard"], description: "Allows pets to benefit from group beneficial spells/songs. Not required for Quick Buff to affect your pet with single-target spells; only required for group spells to affect your pet." },
    ...
    { name: "Point Blank Fire", ranks: 1, costs: ["0"], levelReq: "1", auto: true, eligibleClasses: ["Berserker","Monk","Ranger","Rogue"], description: "Passively grants double and triple attack from ranged attacks regardless of toggle state. Toggleable: prefers ranged weapons for auto attacks, even in melee range." },
    ...
    { name: "Spell Casting Reinforcement", ranks: 4, costs: ["2","4","6","8"], levelReq: "1", eligibleClasses: ["Beastlord","Cleric","Druid","Enchanter","Magician","Necromancer","Paladin","Ranger","Shadow Knight","Shaman","Wizard"], description: "Increases beneficial spell duration by 5/15/30/50%." },
    { name: "Spell Casting Subtlety", ranks: 3, costs: ["2","4","6"], levelReq: "1", eligibleClasses: ["Enchanter","Magician","Necromancer","Wizard"], description: "Toggleable: reduces the amount of hate generated by your attacks and spells by 5/10/20%. (Refresh 0:00:01)" },
    { name: "Thief's Intuition", ranks: 4, costs: ["3","6","9","15"], levelReq: "1", eligibleClasses: ["Bard","Rogue"], description: "Reduces Sense Traps and Disarm Traps reuse time by 1/3/5/5 seconds per rank. Final rank also grants a passive chance to sense traps when near them, at half the effectiveness of the active Sense Traps skill." }
  ],
  ...
  classes: {
    "Bard": [
      ...
      { name: "Reaching Notes", ranks: 3, costs: ["2","4","6"], levelReq: "1", description: "Toggleable: extends the radius of your beneficial area songs by 10/15/25%." },
      ...
      { name: "Symphonic Aura", ranks: 5, costs: ["0","3","3","3","3"], levelReq: "1", autoRanks: 1, description: "Toggleable: allows one/two/three/four/five Bard songs to auto pulse. A song is eligible if it has no mana cost, no cooldown, and is a non-targeted area of effect song; eligible songs cannot be played manually while the ability is on, and are chosen from your final spell gem working backwards. Rank 1 is auto-granted, each additional rank adds one more song for 3 points." },
      { name: "Unbound Versatility", ranks: 3, costs: ["0","0","0"], levelReq: "12", auto: true, description: "Increases your chance to continue casting through a stun by 5/10/15%. Rank 2 requires level 30, rank 3 requires level 50." }
    ],
    "Beastlord": [
      ...
      { name: "Unbound Ferocity", ranks: 3, costs: ["0","0","0"], levelReq: "12", auto: true, description: "Increases your pet's chance to flurry by 3/6/9%. Rank 2 requires level 30, rank 3 requires level 50." }
    ],
    "Berserker": [
    ...
    "Magician": [
      ...
      { name: "Conjurer's Efficiency", ranks: 5, costs: ["3","5","6","6","6"], levelReq: "1", description: "Rank 1: Stops pet summoning components from being consumed. Rank 2: Cuts the cast time of your summon item, pet and target spells by 10%, and of your summon swarm pet spells by 2%. Rank 3: 25% and 5%. Rank 4: 50% and 10%. Rank 5: Reclaim Energy returns 95% of your current pet's base mana cost." },
      ...
      { name: "Turn Summoned", ranks: 3, costs: ["3","6","?"], levelReq: "45", description: "Activated: deals 400/800/? damage to your elemental target, with a 5% chance to trigger a critical 32000 damage effect. (Refresh 0:05:00) Rank 2 requires level 59, above the current level cap - not reachable for now." },
      { name: "Unbound Companion", ranks: 3, costs: ["0","0","0"], levelReq: "12", auto: true, description: "Increases the chance that your pet will land a critical hit by 2/?/?%. Rank 2 requires level 30, rank 3 requires level 50." }
    ],
    "Monk": [
    ...
    "Necromancer": [
      ...
      { name: "Unbound Affliction", ranks: 3, costs: ["0","0","0"], levelReq: "12", auto: true, description: "Increases the chance your damage-over-time spells deal critical damage at each tick by 2/4/6%. Rank 2 requires level 30, rank 3 requires level 50." }
    ],
    "Paladin": [
    ...
    "Rogue": [
      ...
      { name: "Unbound Lethality", ranks: 3, costs: ["0","0","0"], levelReq: "12", auto: true, description: "Increases the duration of your poisons by 10/15/20% and lowers their resist value by 25/50/75. Rank 2 requires level 30, rank 3 requires level 50." }
    ],
    "Shadow Knight": [
